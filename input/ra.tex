...
It is possible to provide a college social network and there are living examples of the same. Many private
colleges and universities have their own network from where students can talk to other students and staff.
...
With the help of some authorities, the project is affordable. This project is on time investment and very
small effort is required to maintain the service up and running.
Since the software used for developing this software is open source, the project is highly economical.
